...
(function (root, factory) {
  ...
  const PROFILES = [
    {
      id: 'gateway', aliases: ['levserver'], name: 'Gateway', label: 'GATEWAY',
      ...
      keyRequired: true, keyEnv: ['STARNET_GATEWAY_KEY', 'LEVSERVER_KEY'], modelsRequireAuth: true,
      baseUrl: 'http://127.0.0.1:8781/v1', baseUrlEnv: ['STARNET_GATEWAY_BASE_URL', 'LEVSERVER_BASE_URL'], modelsPath: '/models',
