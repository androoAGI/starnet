...
**11** open (open+claimed) of 192 total — 0 P0 · 1 P1 · 10 P2

Engineering status is separate from delivery and customer recovery. Legacy rows without origin are not a customer census.

User/owner reports: **93** · source fixed: **82** · installer verified: **6** · customer confirmed: **1** · still reported failing: **2** · recovery unconfirmed: **90**.
