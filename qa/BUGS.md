...
**6** open (open+claimed) of 172 total — 0 P0 · 0 P1 · 6 P2

Engineering status is separate from delivery and customer recovery. Legacy rows without origin are not a customer census.

User/owner reports: **87** · source fixed: **80** · installer verified: **6** · customer confirmed: **1** · still reported failing: **2** · recovery unconfirmed: **84**.
