...
Concurrent integration note: the session-focus lane advanced trunk to ade034edb while the post-merge gate invocations were in flight. Their 733/107 results are receipts for those invocations, not a full-gate certification of the later head. On ade034edb, the image classifier (55 assertions) and real sidecar regression (63 assertions) were rerun and passed. The image source remained unchanged; no later lane was reset or overwritten.
