...
- Tested source: `36ab11f4e`; integration baseline: `8933dc254`.
- Final full fast gate: **765/765 PASS**. Full HTTP gate: **111/111 PASS** on `0c9db8608`; backend, shared contracts, dependencies and HTTP test list are identical in the final source. Subsequent synchronization only retained reviewed logo, sprite and evidence changes.
