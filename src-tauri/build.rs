...
const SHIPPED_INPUTS: &[&str] = &[
    "../frontend",
    // The staged copy Tauri actually embeds (build.frontendDist): frontend/ minus the industrial
    // review/source art, regenerated by scripts/stage-frontend-dist.mjs before every desktop build.
    // Gitignored like binaries/ and voice-deps/, but it DOES ship, so a stale stage must rerun us.
    "frontend-dist",
    "../sidecar",
    "../shared",
    "../remote",
