...
(async () => {
  ...
  A.ok(/payload\.event\(\) == tauri::webview::PageLoadEvent::Finished[\s\S]{0,250}startup_reveal\.finish_load\(\)[\s\S]{0,160}window\.show\(\)/.test(main), 'only the first completed document load may auto-reveal the window');
