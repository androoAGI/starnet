...
const docs="docs/station-remaster/catalog-storage-rest-1",out="frontend/assets/industrial/catalog-storage-rest-1";
const hash=b=>crypto.createHash('sha256').update(b).digest('hex');
const rows=[["boxes","docs/station-remaster/catalog-storage-rest-1/sheet-v2-source.png",null,[0,0,650,295],[0,-1,24,13],[2,1]],["gigs_partsbin","docs/station-remaster/catalog-storage-rest-1/sheet-v2-source.png",null,[650,0,663,295],[-1,-7,26,19],[2,1]],["goldcrate","docs/station-remaster/catalog-storage-rest-1/sheet-v2-source.png",null,[0,295,650,255],[-1,-10,26,22],[2,1]],["toolbox","docs/station-remaster/catalog-storage-rest-1/sheet-v2-source.png",null,[650,295,663,255],[0,1,12,10],[1,1]],["industrial_supplycart","docs/station-remaster/catalog-storage-rest-1/sheet-v2-source.png",null,[0,550,650,287],[1,-11,22,23],[2,1]],["industrial_toolcaddy","docs/station-remaster/catalog-storage-rest-1/sheet-v2-source.png",null,[650,550,663,287],[1,2,10,10],[1,1]],["gigs_servercart","docs/station-remaster/catalog-storage-rest-1/sheet-v2-source.png",null,[0,837,650,361],[1,-6,16,18],[1,1]],["vault","docs/station-remaster/catalog-storage-rest-1/sheet-v2-source.png",null,[650,837,663,361],[-3,-5,44,29],[3,2]]];
...
(async () => {
  ...
  const result={version:1,artSet:'catalog-storage-rest-1-candidate',integrationRoot:"frontend/assets/industrial/catalog-storage-rest-1/",count:records.length,method:'Same alpha core threshold180 and Euclidean radius3 as approved sheet extraction. All original RGB and retained alpha preserved; only detached translucent background alpha removed. Tight crop; no resizing, repainting or recoloring.',sourcesPreserved:true,records};
