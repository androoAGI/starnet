...
const docs="docs/station-remaster/catalog-storage-rest-2",out="frontend/assets/industrial/catalog-storage-rest-2";
const hash=b=>crypto.createHash('sha256').update(b).digest('hex');
const rows=[["calwall","docs/station-remaster/catalog-storage-rest-2/sheet-v2-source.png",null,[0,0,860,260],[-1,-8,74,20],[6,1]],["chartwall","docs/station-remaster/catalog-storage-rest-2/sheet-v2-source.png",null,[860,0,676,260],[-1,-10,38,22],[3,1]],["commswall","docs/station-remaster/catalog-storage-rest-2/sheet-v2-source.png",null,[0,260,880,226],[-1,-13,74,23],[6,1]],["gigs_thumbwall","docs/station-remaster/catalog-storage-rest-2/sheet-v2-source.png",null,[880,260,656,226],[-1,-6,26,18],[2,1]],["industrial_wallpanel","docs/station-remaster/catalog-storage-rest-2/sheet-v2-source.png",null,[0,486,800,252],[0,-13,24,23],[2,1]],["missionboard","docs/station-remaster/catalog-storage-rest-2/sheet-v2-source.png",null,[800,486,736,252],[-1,-13,38,25],[3,1]],["whiteboard","docs/station-remaster/catalog-storage-rest-2/sheet-v2-source.png",null,[0,738,780,286],[-1,-11,50,23],[4,1]],["ticker","docs/station-remaster/catalog-storage-rest-2/sheet-v2-source.png",null,[780,738,756,286],[-1,-8,50,20],[4,1]]];
...
(async () => {
  ...
  const result={version:1,artSet:'catalog-storage-rest-2-candidate',integrationRoot:"frontend/assets/industrial/catalog-storage-rest-2/",count:records.length,method:'Same alpha core threshold180 and Euclidean radius3 as approved sheet extraction. All original RGB and retained alpha preserved; only detached translucent background alpha removed. Tight crop; no resizing, repainting or recoloring.',sourcesPreserved:true,records};
