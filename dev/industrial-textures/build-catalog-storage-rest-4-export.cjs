...
const docs="docs/station-remaster/catalog-storage-rest-4",out="frontend/assets/industrial/catalog-storage-rest-4";
const hash=b=>crypto.createHash('sha256').update(b).digest('hex');
const rows=[["camerarig","docs/station-remaster/catalog-storage-rest-4/sheet-v1-source.png",null,[0,0,520,380],[-1,-6,15,29],[1,2]],["camerarig_r","docs/station-remaster/catalog-storage-rest-4/sheet-v1-source.png",null,[520,0,563,380],[-2,-6,15,29],[1,2]],["gigs_amp","docs/station-remaster/catalog-storage-rest-4/sheet-v1-source.png",null,[0,380,480,310],[-1,-7,16,20],[1,1]],["industrial_partition","docs/station-remaster/catalog-storage-rest-4/sheet-v1-source.png",null,[480,380,603,310],[0,-9,36,21],[3,1]],["research_papers","docs/station-remaster/catalog-storage-rest-4/sheet-v1-source.png",null,[0,690,520,320],[1,1,20,10],[2,1]],["screens","docs/station-remaster/catalog-storage-rest-4/sheet-v1-source.png",null,[520,690,563,320],[-1,-15,26,27],[2,1]],["workbench","docs/station-remaster/catalog-storage-rest-4/sheet-v1-source.png",null,[0,1010,530,443],[-1,-15,30,27],[2,1]],["comms_inbox","docs/station-remaster/catalog-storage-rest-4/sheet-v1-source.png",null,[530,1010,553,443],[-1,-8,30,20],[2,1]]];
...
(async () => {
  ...
  const result={version:1,artSet:'catalog-storage-rest-4-candidate',integrationRoot:"frontend/assets/industrial/catalog-storage-rest-4/",count:records.length,method:'Same alpha core threshold180 and Euclidean radius3 as approved sheet extraction. All original RGB and retained alpha preserved; only detached translucent background alpha removed. Tight crop; no resizing, repainting or recoloring.',sourcesPreserved:true,records};
