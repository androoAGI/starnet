...
const cells=[{"id":"desk2","view":"s","key":"desk2","source":"docs/station-remaster/catalog-storage-rest-5/sheet-v1-source.png","rect":{"x":0,"y":0,"width":735,"height":475},"bounds":{"x":-1,"y":-11,"width":38,"height":23},"footprint":{"w":3,"h":1}},{"id":"desk2","view":"n","key":"desk2-n","source":"docs/station-remaster/catalog-storage-rest-5/sheet-v1-source.png","rect":{"x":735,"y":0,"width":726,"height":475},"bounds":{"x":-2,"y":-11,"width":40,"height":23},"footprint":{"w":3,"h":1}},{"id":"desk2","view":"e","key":"desk2-e","source":"docs/station-remaster/catalog-storage-rest-5/sheet-v1-source.png","rect":{"x":0,"y":475,"width":735,"height":601},"bounds":{"x":-3,"y":-5,"width":18,"height":41},"footprint":{"w":1,"h":3}},{"id":"industrial_partition","view":"e","key":"industrial_partition-e","source":"docs/station-remaster/catalog-storage-rest-3/narrow-correction-source.png","rect":{"x":600,"y":625,"width":599,"height":687},"bounds":{"x":2,"y":-9,"width":8,"height":44},"footprint":{"w":1,"h":3}}];
(async () => {
  ...
  for (const cell of cells) {
    ...
    records.push({id:cell.id,view:cell.view,image:cell.key+'.png',sourceWidth:crop.width,sourceHeight:crop.height,bounds:cell.bounds,footprint:cell.footprint,contact:{y:contactRow/crop.height},actualUniformFit:{width:crop.width*scale,height:crop.height*scale},aspectRatioError:(crop.width/crop.height)/(cell.bounds.width/cell.bounds.height)-1,source:cell.source,sourceSha256,output,outputSha256:hash(png),sourceRect:cell.rect,cropInCell:crop,sourceCrop:{left:left+l,top:top+t,width:crop.width,height:crop.height},width:crop.width,height:crop.height,alphaBounds:{x:0,y:0,width:crop.width,height:crop.height},retainedPixels:retained,alphaResidueRemoved:removed,coreThreshold:180,edgeRadius:radius,opaqueCellEdgePixels,rgbChanges,retainedAlphaChanges,alpha:{zero,partial,opaque255,maxAlpha},liveVerified:false});
  }
  const result={version:1,artSet:'catalog-storage-rest-5-candidate',integrationRoot:"frontend/assets/industrial/catalog-storage-rest-5/",count:records.length,method:'Same alpha core threshold180 and Euclidean radius3 as approved sheet extraction. All original RGB and retained alpha preserved; only detached translucent background alpha removed. Tight crop; no resizing, repainting or recoloring.',sourcesPreserved:true,records};
