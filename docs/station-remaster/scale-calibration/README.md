...
Evaluate at 2 screen pixels per world pixel, the actual station fit zoom, and 3.8x detail separately. Image dimensions alone are not the defect: the ratio of authored feature size to final displayed size, camera angle, value separation and fitted silhouette are the criteria. Do not solve this by globally enlarging every prop, breaking seats/collision, or applying a blur/sharpen filter.

The calibration cohort precedes further production. Source-generation prompts, original images, alpha receipts and native-size comparisons belong here. No candidate is runtime-ready merely because its source PNG or alpha check passes.
