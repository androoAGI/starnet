...
const root=path.resolve(__dirname,'../../../..'),docs=path.join(root,'docs/station-remaster/batch03/storage'),out=path.join(root,'frontend/assets/industrial/batch03/storage');
