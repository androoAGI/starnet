...
const ProjectionPropEffects = (() => {
  ...
  const designs={
    ...
    workbench:[result(rect(.23,.62,.15,.025),C.green)],
    intake:[lamp(rect(.183,.754,.054,.019)),lamp(rect(.54,.754,.045,.019))],
    ...
    comms_dish:[lamp([[.614,.273],[.64,.278],[.658,.303],[.639,.319],[.616,.302]],'work',C.cyan)],
    ...
    war_intelcab:[screen(rect(.24,.29,.49,.18),'work'),result(rect(.42,.53,.09,.017))],
    ...
    gigs_servercart:[lamp(rect(.765,.34,.025,.02),'work',C.green),lamp(rect(.765,.49,.025,.02),'work',C.green),lamp(rect(.765,.64,.025,.02),'work',C.green)],
    ...
    studio:[screen([[.23,.185],[.76,.185],[.80,.46],[.18,.46]],'work',C.rose),result(rect(.69,.65,.065,.04),C.rose)],
  ...
  return {ids,regions,classify,matches,prepare,draw,frameBounds,dispose,coverage:()=>Object.fromEntries(Object.keys(BINDINGS).map(id=>[id,Object.fromEntries(Object.keys(BINDINGS[id]).map(v=>[v,classify(id,v)]))]))};
})();
