...
const PropSprites = (() => {
  ...
  const PROP_2_5D = {
    ...
    industrial_roundtable:{profile:'low',height:8,surface:true}, dinertable:{profile:'low',height:8,surface:true}, booth:{profile:'low',height:8,surface:true}, bar:{profile:'medium',height:16,surface:true}, dinerchair:{profile:'low',height:9}, fishtank:{profile:'medium',height:18}, quarters_minifridge:{profile:'tall',height:22}, quarters_vending:{profile:'tall',height:22}, stool:{profile:'low',height:7},
