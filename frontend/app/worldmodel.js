...
const WorldModel = (() => {
  ...
  return {
    ...
    starterDoc() {
      ...
      room.rects = [
        { x1: 0, y1: 0, x2: 7, y2: 6 },
        { x1: 8, y1: -2, x2: 13, y2: 6 },
        { x1: 14, y1: 0, x2: 21, y2: 6 }
      ];
      room.name = 'HOME';
      room.floorMat = 'resin';
      ...
      doc.props = [
        ...
        // The stepped back wall gives the Commander a recessed central alcove.
        // Utility and media banks flank it; every prop stays at its back wall.
