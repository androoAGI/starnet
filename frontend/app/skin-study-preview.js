...
const SkinStudy=(()=>{
 ...
 async function install(man){
  ...
  const panel=document.createElement('aside');panel.id='skin-study-preview';panel.style.cssText='position:fixed;z-index:99999;top:58px;left:16px;padding:8px 12px;background:#091214e8;border:1px solid #746546;color:#d7c89d;font:12px monospace;max-width:calc(100vw - 32px)';
