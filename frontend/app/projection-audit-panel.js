...
(async()=>{
 ...
 panel.style.cssText='position:fixed;z-index:999999;right:12px;bottom:44px;max-width:360px;padding:12px;background:#091214ef;border:1px solid #746546;color:#d7c89d;font:12px monospace';
