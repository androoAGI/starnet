...
const ProjectionPropEffects = (() => {
  ...
  const designs={
    ...
    workbench:[screen(rect(.158,.065,.225,.11),'work',C.green),result(rect(.709,.633,.019,.026),C.green)],
    ...
    comms_dish:[lamp(rect(.484,.226,.028,.031),'work',C.cyan),screen(rect(.439,.731,.12,.038),'work',C.cyan)],
    ...
    war_intelcab:[screen([[.205,.264],[.451,.264],[.451,.32],[.195,.32]],'work'),result(rect(.52,.265,.027,.018))],
    ...
    gigs_servercart:[screen(rect(.267,.161,.36,.081),'work',C.cyan),result(rect(.715,.167,.034,.03),C.cyan)],
    ...
    studio:[screen(rect(.300,.091,.400,.335),'work',C.rose),result(rect(.824,.438,.035,.02),C.rose)],
