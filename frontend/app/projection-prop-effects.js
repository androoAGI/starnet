...
const ProjectionPropEffects = (() => {
  ...
  const designs={
    ...
    bridge_tacticaltable:[screen([[.155,.09],[.84,.09],[.91,.17],[.93,.36],[.865,.45],[.13,.45],[.075,.37],[.09,.18]],'occupied',C.cyan,0)],
