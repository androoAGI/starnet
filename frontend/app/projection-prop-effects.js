...
const ProjectionPropEffects = (() => {
  ...
  const designs={
    ...
    bridge_tacticaltable:[screen([[.17,.17],[.83,.17],[.89,.31],[.89,.64],[.83,.78],[.17,.78],[.11,.64],[.11,.31]],'occupied',C.cyan,0)],
    ...
    workbench:[result(rect(.042,.84,.022,.024),C.green)],
