...
const ProjectionPropEffects = (() => {
  ...
  const designs={
    ...
    bridge_tacticaltable:[screen([[.126,.135],[.878,.135],[.896,.16],[.896,.55],[.88,.574],[.12,.574],[.105,.55],[.105,.16]],'occupied',C.cyan,0)],
