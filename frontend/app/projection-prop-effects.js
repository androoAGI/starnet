...
const ProjectionPropEffects = (() => {
  ...
  const designs={
    ...
    bridge_tacticaltable:[screen([[.158,.13],[.844,.13],[.896,.20],[.912,.565],[.863,.674],[.13,.674],[.092,.568],[.106,.218]],'occupied',C.cyan,0)],
